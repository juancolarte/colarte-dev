...
(def-call-out sqlite_open (:library "/usr/local/lib/libsqlite.so")
...
(def-call-out sqlite_close (:library "/usr/local/lib/libsqlite.so")
...
(def-call-out sqlite_exec (:library "/usr/local/lib/libsqlite.so")
  (:arguments (db sqlite-ptr)
              (sql c-string)
...
(def-call-out sqlite_last_insert_rowid (:library "/usr/local/lib/libsqlite.so")
  (:arguments (db sqlite-ptr))
  (:return-type sint32)
  (:documentation "Return the id of the last inserted row"))

(def-call-out sqlite_changes (:library "/usr/local/lib/libsqlite.so")
  (:arguments (db sqlite-ptr))
  (:return-type sint32)
  (:documentation "The numbers of rows inserted, deleted, modified by
sqlite_exec or since the last sqlite_compile."))

(def-call-out sqlite_complete (:library "/usr/local/lib/libsqlite.so")
