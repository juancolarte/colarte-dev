...
#+clisp
(defpackage :cl-webapp (:use :cl :ext :socket) (:nicknames :webapp) (:export :serve))
#-clisp
...
(defmethod page-view ((application <application>) (request <request>))
  ...
  (write-line "Content-Type: text/html; charset=EUC-JP")
  (write-line "")
...
(defmethod page-view ((app <hello>) (req <request>))
  ...
  (write-line "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=EUC-JP\">")
  (write-line "<title>Sample Application</title>")
  (write-line "</head><body>")
  (write-line "<h1>Hello, World!!</h1>")
  (write-line "<h1>aha</h1>")
  (write-line "<pre>ouc</pre>")
  (write-line "</body></html>"))
